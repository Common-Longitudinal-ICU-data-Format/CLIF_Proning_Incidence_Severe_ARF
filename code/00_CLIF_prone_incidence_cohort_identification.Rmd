...
pressor_data <- clif_medication_admin_continuous |>
  ...
  mutate(sofa_pressor=case_when((dopa_dose>0 & dopa_dose<=5) | dobut_dose>0~2, dopa_dose>5 | (epi_dose>0 & epi_dose <=0.1) | (norepi_dose>0 & norepi_dose<=0.1) ~3, dopa_dose>15 | epi_dose>0.1 | norepi_dose>0.1 ~4, pressor_on==0~0)) |>
...
#Now Select Max NEE In this 12 Hour Period 
