...
sites <- c('hopkins', 'nu', 'ucmc', 'umn', 'rush', 'penn', 'ohsu', 'umich')
...
new_data <- data.frame(
  characteristic = rep('COVID', 1),
  site = c('rush'),
  Overall = c('157 (71.6)'),
  percent_missing = rep("", 1)
)
...
write.csv(table1_formatted_period, paste0(project_location, '/summary_output/prone_practices_continuous.csv'))
```
