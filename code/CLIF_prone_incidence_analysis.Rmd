...
model_table <- model_table |>
  ...
  mutate(hospital_icc_adjusted=fcase(
    n_hospitals>1 & row_number()==1, round(icc$ICC_adjusted, digits = 3) 
  )) |>
  mutate(icc_note=fifelse(
    is.na(hospital_icc_adjusted) & row_number()==1, 'ICC Did Not Run, May Be Only 1 Hospital', NA_character_
  ))
