...
print('\n Meta-Analysis: COVID Period vs Pre-COVID \n')
summary(res)
...
grid.text("Meta-Analysis: COVID Period vs Pre-COVID", 
          x = 0.5, y = 0.95, 
...
print('\n Meta-Analysis: COVID Period vs Post-COVID \n')
summary(res)
...
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis: COVID Period vs Post-COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
...
study.ids<- c("1", "2", "3", "4", "5", "6", "7", "8")
res<- rma(yi=meta_pre$estimate, sei=meta_pre$std_error, method = "REML", slab=study.ids)
print('\n Meta-Analysis: Pre-COVID vs COVID period (SARS-CoV2[-]) \n')
summary(res)
...
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis: Pre-COVID vs COVID period (SARS-CoV2[-])", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
...
print('\n Meta-Analysis COVID Period: SARS-CoV2(-) vs SARS-CoV2(+) \n')
summary(res)
...
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis COVID Period: SARS-CoV2(-) vs SARS-CoV2(+)", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
...
study.ids<- c("1", "2", "3", "4", "5", "6", "7", "8")
res<- rma(yi=meta$estimate, sei=meta$std_error, method = "REML", slab=study.ids)
print('\n Meta-Analysis: Post-COVID vs COVID;SARS-CoV2(-) ')
summary(res)
meta1<- metagen(TE=meta$estimate , seTE=meta$std_error , common=F, random=T, method.tau = "REML", sm="OR", studlab = study.ids)
pdf(paste0(project_location, "/summary_output/graphs/meta_analysis_post_covid_sarsneg.pdf"), width = 7.3, height = 5)
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis: Post-COVID vs COVID with SARS-CoV2(-)", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Post-COVID", x=.535, y=.83, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n COVID-Period \n (SARS-CoV2[-])", x=.73, y=.83, gp=gpar(fontsize=10, fontface="bold"))
dev.off()
```
...
print('\n Meta-Analysis, Severe ARDS Only: Pre-COVID vs COVID \n')
summary(res)
...
grid.text("Meta-Analysis, Severe ARDS Only: Pre-COVID vs COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Pre-COVID", x=.535, y=.83, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n COVID-", x=.73, y=.83, gp=gpar(fontsize=10, fontface="bold"))
dev.off()
...
meta <- meta_severe %>% filter(term=='study_periodPost-COVID') |>
  ...
  arrange(n_observations)
res<- rma(yi=meta$estimate, sei=meta$std_error, method = "REML")
print('\n Meta-Analysis, Severe ARDS Only: Post-COVID vs COVID \n')
summary(res)
meta1<- metagen(meta$estimate , meta$std_error, common=F, random=T, method.tau = "REML", sm="OR")
pdf(paste0(project_location, "/summary_output/graphs/meta_analysis_covid-post_Severe.pdf"), width = 7.3, height = 5)
forest(meta1, layout = "JAMA", backtransf = TRUE)
grid.text("Meta-Analysis, Severe ARDS Only: Post-COVID vs COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Post-COVID", x=.535, y=.83, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n COVID-", x=.73, y=.83, gp=gpar(fontsize=10, fontface="bold"))
...
meta <- meta_moderate %>% filter(term=='study_periodPre-COVID') |>
  ...
  arrange(n_observations)
res<- rma(yi=meta$estimate, sei=meta$std_error, method = "REML")
print('\n Meta-Analysis, Moderate ARDS Only: Pre-COVID vs COVID \n')
summary(res)
meta1<- metagen(meta$estimate , meta$std_error, common=F, random=T, method.tau = "REML", sm="OR")
pdf(paste0(project_location, "/summary_output/graphs/meta_analysis_covid-pre_Moderate.pdf"), width = 7.3, height = 5)
forest(meta1, layout = "JAMA", backtransf = TRUE)
grid.text("Meta-Analysis, Moderate ARDS Only: Pre-COVID vs COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Pre-COVID", x=.535, y=.83, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n COVID-", x=.73, y=.83, gp=gpar(fontsize=10, fontface="bold"))
...
meta <- meta_moderate %>% filter(term=='study_periodPost-COVID') |>
  ...
  arrange(n_observations)
res<- rma(yi=meta$estimate, sei=meta$std_error, method = "REML")
print('\n Meta-Analysis, Moderate ARDS Only: Post-COVID vs COVID \n')
summary(res)
meta1<- metagen(meta$estimate , meta$std_error, common=F, random=T, method.tau = "REML", sm="OR")
pdf(paste0(project_location, "/summary_output/graphs/meta_analysis_covid-post_Moderate.pdf"), width = 7.3, height = 5)
forest(meta1, layout = "JAMA", backtransf = TRUE)
grid.text("Meta-Analysis, Moderate ARDS Only: Post-COVID vs COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Post-COVID", x=.535, y=.83, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n COVID-", x=.73, y=.83, gp=gpar(fontsize=10, fontface="bold"))
...
study.ids<- c("1", "2", "3", "4", "5", "6", "7", "8")
res<- rma(yi=meta_pre$estimate, sei=meta_pre$std_error, method = "REML", slab=study.ids)
print('\n Meta-Analysis (72 Hour Proning(: COVID Period vs Pre-COVID \n')
summary(res)
meta1<- metagen(meta_pre$estimate , meta_pre$std_error , common=F, random=T, method.tau = "REML", sm="OR", studlab = study.ids)
pdf(paste0(project_location, "/summary_output/graphs/meta_analysis_covid-pre_prone72.pdf"), width = 7.3, height = 5)
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis (72 Hour Proning): COVID Period vs Pre-COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Pre-Pandemic", x=.535, y=.8, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n Pandemic", x=.73, y=.8, gp=gpar(fontsize=10, fontface="bold"))
...
study.ids<- c("1", "2", "3", "4", "5", "6", "7", "8")
res<- rma(yi=meta_post$estimate, sei=meta_post$std_error, method = "REML", slab=study.ids)
print('\n Meta-Analysis (72 Hour Proning: COVID Period vs Post-COVID \n')
summary(res)
meta1<- metagen(TE=meta_post$estimate , seTE=meta_post$std_error , common=F, random=T, method.tau = "REML", sm="OR", studlab = study.ids)
pdf(paste0(project_location, "/summary_output/graphs/meta_analysis_covid-post_prone72.pdf"), width = 7.3, height = 5)
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis (72 Hour Proning): COVID Period vs Post-COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Post-Pandemic", x=.535, y=.83, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n Pandemic", x=.73, y=.83, gp=gpar(fontsize=10, fontface="bold"))
...
res<- rma(yi=meta_pre$estimate, sei=meta_pre$std_error, method = "REML", slab=study.ids)
print('\n Meta-Analysis, Sites with All Periods: COVID Period vs Pre-COVID \n')
summary(res)
meta1<- metagen(meta_pre$estimate , meta_pre$std_error , common=F, random=T, method.tau = "REML", sm="OR", studlab = study.ids)
pdf(paste0(project_location, "/summary_output/graphs/meta_analysis_covid-pre_sites_all_periods.pdf"), width = 7.3, height = 5)
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis, Sites with All Periods: COVID Period vs Pre-COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Pre-Pandemic", x=.535, y=.8, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n Pandemic", x=.73, y=.8, gp=gpar(fontsize=10, fontface="bold"))
...
study.ids<- c("1", "2", "3", "4", "5", "6", "7")
res<- rma(yi=meta_post$estimate, sei=meta_post$std_error, method = "REML", slab=study.ids)
print('\n Meta-Analysis, Sites with All Periods: COVID Period vs Post-COVID \n')
summary(res)
meta1<- metagen(TE=meta_post$estimate , seTE=meta_post$std_error , common=F, random=T, method.tau = "REML", sm="OR", studlab = study.ids)
...
print('\n Meta-Analysis, ICD-10 Only: COVID Period vs Pre-COVID \n')
summary(res)
...
forest(meta1, layout = "JAMA", backtransf = TRUE)
grid.text("Meta-Analysis, ICD-10 Only: COVID Period vs Pre-COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Pre-Pandemic", x=.535, y=.8, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n Pandemic", x=.73, y=.8, gp=gpar(fontsize=10, fontface="bold"))
...
forest(meta1, layout = "JAMA", backtransf = TRUE, names=study.ids)
grid.text("Meta-Analysis, ICD-10 Only: COVID Period vs Post-COVID", 
          x = 0.5, y = 0.95, 
          gp = gpar(fontsize = 14, fontface = "bold"))
grid.text("Favors \n Post-Pandemic", x=.535, y=.83, gp=gpar(fontsize=10, fontface="bold"))
grid.text("Favors \n Pandemic", x=.73, y=.83, gp=gpar(fontsize=10, fontface="bold"))
