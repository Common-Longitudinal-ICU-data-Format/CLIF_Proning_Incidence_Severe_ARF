...
if (n_hospitals>1) {
model_form_step <- prone_24hour_outcome ~ study_period + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id)
} else {
  model_form_step <- prone_24hour_outcome ~ study_period + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio
}
...
#Will Scale STudy Month So Coefficients Tell Us About Change in Log Odds Per 3 month Change
if (n_hospitals>1) {
model_form_step <- prone_24hour_outcome ~ study_period + study_period:month_scaled + age_at_admission + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id) 
} else {
  model_form_step <- prone_24hour_outcome ~ study_period + study_period:month_scaled + age_at_admission + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio
}
...
if (n_hospitals>1) {
  model_form_step <- prone_24hour_outcome ~ covid_period + covid_period:month_scaled + age_at_admission+ bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id)
} else {
model_form_step <- prone_24hour_outcome ~ covid_period + covid_period:month_scaled + age_at_admission+ bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio 
}
...
#Now Multivariable
if (n_hospitals>1) {
model_form_step <- prone_24hour_outcome ~ month_scaled + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id)
} else {
  model_form_step <- prone_24hour_outcome ~ month_scaled + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio
}
two_period_multivar_mod <- glm(model_form_step,
          data = prone_analytic_df, 
          family=binomial)
...
if (n_hospitals>1) {
model_form_step <- prone_72hour_outcome ~ study_period + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id)
} else {
  model_form_step <- prone_72hour_outcome ~ study_period + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio
}
...
#Will Scale STudy Month So Coefficients Tell Us About Change in Log Odds Per 3 month Change
if (n_hospitals>1) {
model_form_step <- prone_72hour_outcome ~ study_period + study_period:month_scaled + age_at_admission + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id) 
} else {
  model_form_step <- prone_72hour_outcome ~ study_period + study_period:month_scaled + age_at_admission + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio
}
...
if (n_hospitals>1) {
  model_form_step <- prone_72hour_outcome ~ covid_period + covid_period:month_scaled + age_at_admission+ bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id)
} else {
model_form_step <- prone_72hour_outcome ~ covid_period + covid_period:month_scaled + age_at_admission+ bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio 
}
...
#Now Multivariable
if (n_hospitals>1) {
model_form_step <- prone_72hour_outcome ~ month_scaled + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio + factor(hospital_id)
} else {
  model_form_step <- prone_72hour_outcome ~ month_scaled + age_at_admission  + bmi + factor(max_norepi_equivalent) + or_before_enrollment + min_pf_ratio
}
two_period_multivar_mod <- glm(model_form_step,
          data = prone_analytic_df, 
          family=binomial)
