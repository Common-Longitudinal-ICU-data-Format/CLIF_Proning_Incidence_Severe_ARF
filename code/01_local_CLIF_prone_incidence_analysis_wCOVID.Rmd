...
---
#This File is Run AFTER the Cohort Identification R Markdown ('00_cohort_identification_prone_incidence.Rmd')
...
# Define the cast function to convert large_string to string (if needed)
...
# Apply cast function to normalize Arrow string types
prone_analytic_df <- cast_large_utf8_to_utf8(prone_analytic_df)
